...
<FORM name="frmLogin" method="POST" action="./<%=actionConex%>.html">
    <p>
        <span class="labelFormLogin">Nick:</span> <input type="text" class="campoForm" name="ident_usu" size="15" maxlength="15" value=""/>
